...
if ($assetType) {
    ...
    $query = "SELECT k.assetno, m.assettype, m.givenbyempid, m.usedbyempid, k.useddate, k.usedremark, k.useddocno, k.temporarydate, k.remark, k.usedapproval
              FROM keluar k
              JOIN master m ON m.assetno = k.assetno
                                                ...
                                                <tr>
                                                    <td><?php echo ($detail['assetno']); ?></td>
                                                        <td><?php echo ($detail['assettype']); ?></td>
                                                         <td><?php echo ($detail['givenbyempid']); ?></td>
                                                        <td><?php echo ($detail['usedbyempid']); ?></td>
                                                        <td><?php echo ($detail['useddate']); ?></td>
                                                        <td><?php echo ($detail['temporarydate']); ?></td>
                                                        <td><?php echo ($detail['usedremark']); ?></td>
                                                        <td><?php echo ($detail['useddocno']); ?></td>
                                                        <td><?php echo ($detail['remark']); ?></td>
                                                        <td><?php echo ($detail['usedapproval']); ?></td>
                                                </tr>
                                            <?php endwhile; ?>
                                        </tbody>
                                    </table>
